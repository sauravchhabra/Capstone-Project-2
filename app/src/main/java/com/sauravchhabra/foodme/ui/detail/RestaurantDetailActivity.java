...
import com.sauravchhabra.foodme.common.BaseOnlyFragmentActivity;
import com.sauravchhabra.foodme.common.ViewPagerAdapter;
import com.sauravchhabra.foodme.data.local.entity.CommonRestaurant;
import com.sauravchhabra.foodme.databinding.ActivityRestaurantDetailBinding;
...
public class RestaurantDetailActivity extends BaseOnlyFragmentActivity<ActivityRestaurantDetailBinding, RestaurantDetailViewModel> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            if (getIntent().getExtras().getSerializable(ConstantsUtils.RESTAURANTS_BUNDLE_KEY) instanceof NearbyRestaurant) {
                NearbyRestaurant nearbyRestaurant = (NearbyRestaurant) getIntent().getExtras().getSerializable(ConstantsUtils.RESTAURANTS_BUNDLE_KEY);
            ...
            } else if (getIntent().getExtras().getSerializable(ConstantsUtils.RESTAURANTS_BUNDLE_KEY) instanceof CommonRestaurant) {
                commonRestaurant = (CommonRestaurant) getIntent().getExtras().getSerializable(ConstantsUtils.RESTAURANTS_BUNDLE_KEY);
                appBarBehaviour(commonRestaurant);
            } else if (getIntent().getExtras().getSerializable(ConstantsUtils.RESTAURANTS_BUNDLE_KEY) instanceof Restaurant) {
                Restaurant restaurant = (Restaurant) getIntent().getExtras().getSerializable(ConstantsUtils.RESTAURANTS_BUNDLE_KEY);
